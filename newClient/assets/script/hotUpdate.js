cc.Class({
    ...
    checkCb: function (event) {
        GameLog('Code: ' + event.getEventCode());
        ...
        switch (event.getEventCode())
        {
            ...
            case jsb.EventAssetsManager.UPDATE_PROGRESSION:
                ...
                if (msg) {
                    ...
                    GameLog(event.getPercent().toFixed(2) + '% : ' + msg);
                }
                break;
            case jsb.EventAssetsManager.ERROR_DOWNLOAD_MANIFEST:
            case jsb.EventAssetsManager.ERROR_PARSE_MANIFEST:
    ...
    onLoad: function () {
        ...
        GameLog('Storage path for remote assets : ' + storagePath);

        GameLog('Local manifest URL : ' + this.manifestUrl);
        ...
        this._am.setVersionCompareHandle(function (versionA, versionB) {
            GameLog("JS Custom Version Compare: version A is " + versionA + ', version B is ' + versionB);
